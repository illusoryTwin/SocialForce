...
def calculate_impact_factor_by_vel(window_size=3, selected_id_pair=[1, 3]):
    ...
    def calculate_impact_factor(df: pd.DataFrame, id_pair: list[int]) -> pd.DataFrame:
        ...
        impact_factor = (v_norm / r_norm) * cos_theta
    ...
    impact_df[["timestamp", "impact_factor"]].to_csv(impact_factor_path, index=False)
